...
//        std::string consensus;
    ...
    Profile computePSSMFromMSA(size_t setSize, size_t queryLength, const char **msaSeqs, bool wg, float scoreBias, std::vector<double> branchWeights, std::vector<size_t> &indices); 
